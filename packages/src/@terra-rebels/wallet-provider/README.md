...
Library to make React dApps easier using Rebel Station Extension or Rebel Station Mobile.
...
<https://github.com/terra-rebels/wallet-provider/tree/main/templates/create-react-app>
...
<https://github.com/terra-rebels/wallet-provider/tree/main/templates/next>

### Other templates

- [Wallet Provider + Vite.js](https://github.com/terra-rebels/wallet-provider/tree/main/templates/vite)
- [Wallet Controller + Lit](https://github.com/terra-rebels/wallet-provider/tree/main/templates/lit)
- [Wallet Controller + Vue.js](https://github.com/terra-rebels/wallet-provider/tree/main/templates/vue)
- [Wallet Controller + Svelte](https://github.com/terra-rebels/wallet-provider/tree/main/templates/svelte)

### Community templates (experimental)

You can find more templates in <https://templates.terrarebels.net>. (This is the beginning stage, so it may not be enough yet)

If you make a different type of template, you can register [here](https://github.com/terra-rebels/templates).
...
<!-- source packages/src/@terra-rebels/use-wallet/useWallet.ts --pick "Wallet" -->

[packages/src/@terra-rebels/use-wallet/useWallet.ts](packages/src/@terra-rebels/use-wallet/useWallet.ts)
...
export interface Wallet {
   ...
   * ```
   *
   * This type is same as `import type { TerraWebExtensionFeatures } from '@terra-rebels/web-extension-interface'`
   */
  supportFeatures: Set<
...
```jsx
import { useLCDClient } from '@terra-rebels/wallet-provider';
...
- [Releases (Changelog)](https://github.com/terra-rebels/wallet-provider/releases)
...
You can check `src/@terra-rebels/wallet-provider/` in the Chrome Devtools / Sources Tab, and you can also use breakpoints
here for debug.
...
the `packages/src/@terra-rebels/wallet-provider/env.ts` file. (or just make an issue is OK)
