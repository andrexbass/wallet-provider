...
} from '@terra-rebels/web-extension-interface';
...
export interface WalletControllerOptions
   ...
   * for walletconnect
   *
   * The network rules passed by the Rebel Station Mobile are 0 is testnet, 1 is mainnet.
   *
...
const CONNECTIONS = {
  [ConnectType.READONLY]: {
    ...
    icon: 'https://assets.terrarebels.net/icon/wallet-provider/readonly.svg',
  } as Connection,
  [ConnectType.WALLETCONNECT]: {
    type: ConnectType.WALLETCONNECT,
    name: 'Wallet Connect',
    icon: 'https://assets.terrarebels.net/icon/wallet-provider/walletconnect.svg',
  } as Connection,
} as const;
